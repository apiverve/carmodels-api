...
class carmodelsWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/carmodels');
        }
        ...
        this.validationRules = {"make":{"type":"string","required":true},"year":{"type":"integer","required":false,"min":1984,"max":2030}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/carmodels`);
        }
    }
...
module.exports = carmodelsWrapper;
