...
/**
 * Client for the US Car Models API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://carmodels.apiverve.com?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/carmodels';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CarmodelsClient] {$message}\n";
        }
    }
}
