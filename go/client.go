...
const (
	baseURL        = "https://api.apiverve.com/v1/carmodels"
	defaultTimeout = 30 * time.Second
)

// Client is the Car Models API client.
type Client struct {
	apiKey     string
	httpClient *resty.Client
}

// NewClient creates a new Car Models API client.
...
// Execute makes a request to the Car Models API with typed parameters.
//
