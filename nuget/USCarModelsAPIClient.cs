...
namespace APIVerve.API.USCarModels
{
    ...
    /// <summary>
    /// Client for the USCarModels API
    /// </summary>
    public class USCarModelsAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/carmodels";
        ...
        {
            { "make", new ValidationRule { Type = "string", Required = true } },
            { "year", new ValidationRule { Type = "integer", Required = false, Min = 1984, Max = 2030 } }
        };
        ...
        public USCarModelsAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public USCarModelsAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public USCarModelsAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, USCarModelsQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(USCarModelsQueryOptions options)
        {
        ...
        public ResponseObj Execute(USCarModelsQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(USCarModelsQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(USCarModelsQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(USCarModelsQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(USCarModelsQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(USCarModelsQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(USCarModelsQueryOptions options)
        {
