...
namespace APIVerve.API.CarModels
{
    ...
    /// <summary>
    /// Client for the CarModels API
    /// </summary>
    public class CarModelsAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        ...
        public CarModelsAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CarModelsAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CarModelsAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, CarModelsQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(CarModelsQueryOptions options)
        {
        ...
        public ResponseObj Execute(CarModelsQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(CarModelsQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(CarModelsQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(CarModelsQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(CarModelsQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(CarModelsQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(CarModelsQueryOptions options)
        {
